...
class Clever_Adminhtml_Cms_PageController extends Mage_Adminhtml_Cms_PageController
{
    ...
    public function treeAction()
    {
        ...
        $page = $this->_initPage();
        $block = $this->getLayout()->createBlock('adminhtml/cms_page_tree');
        $root = $block->getRoot();
    ...
    public function pagesJsonAction()
    {
        ...
        if ($pageId = (int) $this->getRequest()->getPost('id')) {
            ...
            $this->getResponse()->setBody(
                $this->getLayout()->createBlock('adminhtml/cms_page_tree')
                    ->getTreeJson($page)
            );
        }
    }
