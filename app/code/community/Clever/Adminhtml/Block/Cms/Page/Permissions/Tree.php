...
class Clever_Adminhtml_Block_Cms_Page_Permissions_Tree extends Mage_Adminhtml_Block_Template
{
    ...
    public function getRoot()
    {
        if (null === $this->_root) {
            ...
            if (! $this->_root->getId()) {
                $this->_root = Clever_Cms_Model_Page::createDefaultStoreRootPage($storeId);
            }
        }
    ...
    protected function _getNodeJson(Clever_Cms_Model_Page $page)
    {
        $item = array();
